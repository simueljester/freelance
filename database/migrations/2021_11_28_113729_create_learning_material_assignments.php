...
class CreateLearningMaterialAssignments extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('learning_material_assignments', function (Blueprint $table) {
            ...
            $table->foreign('learning_material_id')->references('id')->on('learning_materials')->onDelete('cascade')->onUpdate('cascade');
