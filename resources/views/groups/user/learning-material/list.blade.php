        ...
        <div class="card mt-3 shadow-sm">
            ...
            <div class="card-body">
                ...
                @if ($assignment->learning_material->file)
                    ...
                    <i class="fas fa-download"></i> <a href="{{route('downloads.learning-material-attachment',$assignment->learning_material->file)}}" class="text-info"> {{$assignment->learning_material->file}} </a>
                @endif
            </div>
