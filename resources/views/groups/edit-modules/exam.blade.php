    ...
    <div class="card shadow-sm mt-3">
        <div class="card-body">
            ...
            <div class="form-group mt-3">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <input type="date" name="expiration_date" id="expiration_date"  class="form-control" value="{{ $exam->expired_at ? Carbon\Carbon::parse($exam->expired_at)->format('Y-m-d') : null}}" >
                    </div>
                    <div class="col-sm-6">
                        <input type="time" name="expiration_time" id="expiration_time"  class="form-control" value="{{ $exam->expired_at ? Carbon\Carbon::parse($exam->expired_at)->format('H:i') : null }}" >
                    </div>
                </div>
            </div>
            <div class="form-group mt-3">
