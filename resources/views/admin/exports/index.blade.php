        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td> <a href="{{route('administrator.exports.question-bank')}}" class="btn btn-sm btn-info" target="_blank"> <i class="fas fa-cloud-download-alt"></i> Export </a> </td>
                </tr>
                <tr>
                    <td> <i class="fas fa-sign-in-alt"></i> Login Report </td>
                    <td> <a href="{{route('administrator.exports.login-report')}}" class="btn btn-sm btn-info" target="_blank"> <i class="fas fa-cloud-download-alt"></i> Export </a> </td>
                </tr>
                <tr>
